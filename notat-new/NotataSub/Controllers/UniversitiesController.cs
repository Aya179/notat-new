...
namespace NotataSub.Controllers
{
    public class UniversitiesController : Controller
    {
        ...
        public UniversitiesController(StudyHubContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UniversityName,City,UniversityId,IsDeleted")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UniversityName,City,UniversityId,IsDeleted")] University university)
        {
